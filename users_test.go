...
func TestAPI_UpdateUser(t *testing.T) {
	...
	userID := "7fb3ce9f-a866-4dff-8ce8-2f64f7c5ed4c"

	t.Run("200", func(t *testing.T) {
		runServer(t, "/users/7fb3ce9f-a866-4dff-8ce8-2f64f7c5ed4c", http.MethodPut, http.StatusOK, func(config Config) {
			api := New(config)
			user, err := api.UpdateUser(userID, request)
	...
	t.Run("400", func(t *testing.T) {
		...
		runServer(t, "/users/7fb3ce9f-a866-4dff-8ce8-2f64f7c5ed4c", http.MethodPut, http.StatusBadRequest, func(config Config) {
			api := New(config)
			user, err := api.UpdateUser(userID, request)
	...
	t.Run("500", func(t *testing.T) {
		runServer(t, "/users/7fb3ce9f-a866-4dff-8ce8-2f64f7c5ed4c", http.MethodPut, http.StatusInternalServerError, func(config Config) {
			api := New(config)
			user, err := api.UpdateUser(userID, request)
